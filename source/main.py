...
geo_generator(filename='trelica', num_segmentos = 4, l_base = 3.5, h_base = 5.5, ponto_final = (-30.0, 0.0, 15.0), ID = 1)    # Benchmark 01
...
plotar_estrutura_deformada(nodes, elements-1, deslocamentos, escala_deformacao=1.0)                                        # plot
plotar_tensoes(nodes, elements-1, tensoes, deslocamentos, escala_deformacao=1.0)                                           # plot
